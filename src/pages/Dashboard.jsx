    ...
    >
      ...
      <aside className="w-72 bg-white dark:bg-zinc-950 border-r border-gray-200 dark:border-zinc-900 p-6 hidden md:flex flex-col transition-colors duration-300">
        ...
        <nav className="flex flex-col gap-3">
          ...
          {/* Panel de Juez para admin y judge */}
          {(userData?.role === "admin" || userData?.role === "judge") && (
            <button onClick={() => goTo("/judge")} className="flex items-center gap-4 px-5 py-4 rounded-2xl bg-gray-100/70 dark:bg-zinc-900 hover:bg-gray-200/80 dark:hover:bg-zinc-800 text-gray-700 dark:text-gray-300 transition font-medium">
              <Timer size={22} />
              Panel de Juez
            </button>
          )}
